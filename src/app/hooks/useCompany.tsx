...
export const validate = (values: UpdateCompanyInput) => {
  ...
  if (values.fax && !/^\+?[0-9]{7,15}$/.test(values.fax)) {
  ...
  if (!values.primaryContactPerson?.email) {
    ...
    !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(values.primaryContactPerson.email)
  ) {
    errors.primaryContactPerson = {
      ...errors.primaryContactPerson,
  ...
  if (
    values.primaryContactPerson?.phone &&
    !/^\+?[0-9]{7,15}$/.test(values.primaryContactPerson.phone)
  ) {
    errors.primaryContactPerson = {
      ...errors.primaryContactPerson,
